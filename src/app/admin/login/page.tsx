        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-950 p-4">
            <div className="w-full max-w-md bg-slate-900 rounded-xl shadow-2xl border border-slate-800 p-8 space-y-6">
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            className="w-full h-10 px-3 py-2 bg-slate-950 border border-slate-800 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all"
                    ...
                    <button
                        type="submit"
                        className="w-full h-11 bg-blue-500 hover:bg-blue-600 text-white font-medium rounded-lg transition-colors flex items-center justify-center mt-2"
                    >
                        Access Dashboard
                    </button>
                </form>
                ...
                <div className="text-center text-xs text-slate-500 pt-2">
                    &copy; {new Date().getFullYear()} BSW Interiors
                </div>
            </div>
        </div>
    );
