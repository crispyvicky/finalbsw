                ...
                <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-1">
                            ...
                            <input type="text" defaultValue="BSW Interiors" className="w-full p-2.5 border border-slate-200 rounded-lg focus:ring-2 focus:ring-slate-900/10 focus:outline-none" />
                        </div>
                        <div className="space-y-1">
