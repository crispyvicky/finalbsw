                        ...
                        <div className="space-y-4 mt-8">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <input
                                    ...
                                    className="w-24 p-1 text-center text-slate-900 font-bold rounded bg-white outline-none focus:ring-2 focus:ring-blue-400 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                                    onWheel={(e) => (e.target as HTMLInputElement).blur()}
                                />
                            </div>
                            <div className="flex justify-between items-center">
