...
import { Loader2, Download, Phone, CreditCard } from 'lucide-react';
...
export default function PublicInvoiceView() {
    ...
    if (!invoice) return <div className="h-screen flex items-center justify-center text-slate-500">Invoice not found or expired.</div>;
            ...
            <div className="bg-white p-4 md:p-6 shadow-sm sticky top-0 z-50 print:hidden">
                <div className="max-w-7xl mx-auto flex justify-between items-center">
                    <div>
                        ...
                        <div className="text-xs md:text-sm text-slate-500 mt-1">Invoice #{invoice.invoiceNumber}</div>
                    </div>
