                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    ...
                    <div className="hero-content flex-1 text-center lg:text-left space-y-8">
                        <div className="space-y-4">
                            <span className="inline-block px-3 py-1 bg-[#0F2557]/10 text-[#0F2557] text-xs font-bold tracking-[0.2em] uppercase mb-4">
                                Online Cost Calculator
                            </span>
                            <h1 className="font-heading-01 text-5xl md:text-6xl lg:text-7xl text-[#1a1a1a] leading-[1.1]">
                                Interior Design <br />
                                <span className="text-[#0F2557] italic font-heading-03 font-normal">Cost Estimator</span>
                            </h1>
                        ...
                        <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start">
                            <Button
                                className="group h-14 px-8 rounded-none border border-[#0F2557] bg-[#0F2557] text-white hover:bg-[#2F4F2F] transition-all duration-300 flex items-center gap-3 w-fit mx-auto lg:mx-0 shadow-lg"
                                onClick={onStart}
                            >
                        ...
                        {/* Stats - Horizontal */}
                        <div className="pt-8 border-t border-[#A0A0A0]/20 grid grid-cols-3 gap-8">
                            {[
                                ...
                                <div key={i} className="text-center lg:text-left">
                                    <div className="font-heading-05 text-2xl lg:text-3xl font-bold text-[#0F2557] mb-1">{stat.value}</div>
                                    <div className="font-body-02 text-xs text-[#A0A0A0] uppercase tracking-widest">{stat.label}</div>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="hero-image flex-1 w-full max-w-lg lg:max-w-xl relative">
                        ...
                        {/* Floater Element */}
                        <div className="absolute -bottom-8 -left-8 bg-[#f5f2eb] p-6 shadow-xl border border-[#A0A0A0]/20 max-w-[200px] hidden md:block">
                            <div className="flex items-center gap-3 mb-3">
                                <Calculator className="w-5 h-5 text-[#A0A0A0]" />
                                <span className="font-bold text-xs uppercase tracking-widest text-[#0F2557]">Instant</span>
                            </div>
